            ...
            <div className="flex flex-col max-w-4xl min-w-max items-center w-9/12 h-2/3">
                ...
                <div className=" flex self-center w-full h-fit gap-20 pt-7 pb-10 ring-deep-blue ring-2 bg-bright-white">
                    <div className=" flex flex-col justify-between gap-6 w-3/5">
                        ...
                        <TextInput label="Nome:"      txtValue={user!==undefined?user.nome:''} placeholder="Seu nome completo" OnChange={(e: any)=>{ setNome(e) ;}}/>
                        <TextInput label="E-mail:"    txtValue={user!==undefined?user.email:''} placeholder="email@email.com" OnChange={(e: any)=>{ setEmail(e) ;}}/>
                        <TextInput label="Senha:" senha   txtValue={user!==undefined?user.senha:''} placeholder="*********" OnChange={(e: any)=>{ setSenha(e) ;}}/>
                        
                    </div>

                    <div className="flex flex-col gap-6 mr-7 pr-12">
                        <TextInput label="CPF:"       txtValue={user!==undefined?user.cpf:''} placeholder="123.456.789-10" OnChange={(e: any)=>{ setCPF(e) ;}}/>
                        <TextInput label="Telefone:"  txtValue={user!==undefined?undefined:''} placeholder="99 99999-9999" OnChange={(e: any)=>{ setTelefone(e) ;}}/>
